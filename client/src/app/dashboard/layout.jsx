...
import {
  ...
  X, Timer, Trash2, Plus, BookOpen, LogOut, Bell, Palette, User,
  FileUp, Video, ChevronDown, Map,
} from 'lucide-react';
...
const navGroups = [
  ...
  },
  {
    label: 'Learn & Create',
    items: [
      { icon: MessageSquare, label: 'AI Tutor',       href: '/dashboard/chat',        badge: null },
      { icon: Wand2,         label: 'Generate Notes', href: '/dashboard/generate',    badge: null },
      { icon: Youtube,       label: 'Video Notes',    href: '/dashboard/video-notes', badge: null },
      { icon: FileText,      label: 'My Notes',       href: '/dashboard/notes',       badge: null },
      { icon: FolderOpen,    label: 'Subjects',       href: '/dashboard/subjects',    badge: null },
    ],
  },
  {
    label: 'Practice & Test',
    items: [
      { icon: Brain,        label: 'AI Quiz',      href: '/dashboard/quiz',       badge: null },
      { icon: Layers,       label: 'Flashcards',   href: '/dashboard/flashcards', badge: null },
  ...
  },
  {
    label: 'Plan & Revise',
    items: [
      { icon: CalendarDays, label: 'Study Planner',    href: '/dashboard/planner',  badge: null },
      { icon: RefreshCw,    label: 'Revision Tracker', href: '/dashboard/revision', badge: null },
      { icon: Timer,        label: 'Pomodoro Timer',   href: '/dashboard/pomodoro', badge: null },
    ],
  },
  {
    label: 'Account',
    items: [
      { icon: Trash2,   label: 'Trash',    href: '/dashboard/trash',    badge: null },
